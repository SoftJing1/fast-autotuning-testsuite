...
GemmConfig load_config_from_json(const std::string& json_path) {
    ...
    try {
        ...
        // Load input sizes
        if (j.contains("M")) config.M = j["M"];
        if (j.contains("N")) config.N = j["N"];
        if (j.contains("K")) config.K = j["K"];
        
        // Load tuning parameters
        if (j.contains("cache_l_cb")) config.cache_l_cb = j["cache_l_cb"];
        if (j.contains("cache_p_cb")) config.cache_p_cb = j["cache_p_cb"];
        ...
        if (j.contains("input_size_l_1")) config.input_size_l_1 = j["input_size_l_1"];
        if (j.contains("l_cb_size_l_1")) config.l_cb_size_l_1 = j["l_cb_size_l_1"];
        if (j.contains("p_cb_size_l_1")) config.p_cb_size_l_1 = j["p_cb_size_l_1"];
        if (j.contains("ocl_dim_l_1")) config.ocl_dim_l_1 = j["ocl_dim_l_1"];
        if (j.contains("num_wg_l_1")) config.num_wg_l_1 = j["num_wg_l_1"];
        if (j.contains("num_wi_l_1")) config.num_wi_l_1 = j["num_wi_l_1"];
        if (j.contains("input_size_l_2")) config.input_size_l_2 = j["input_size_l_2"];
        if (j.contains("l_cb_size_l_2")) config.l_cb_size_l_2 = j["l_cb_size_l_2"];
        if (j.contains("p_cb_size_l_2")) config.p_cb_size_l_2 = j["p_cb_size_l_2"];
        if (j.contains("ocl_dim_l_2")) config.ocl_dim_l_2 = j["ocl_dim_l_2"];
        if (j.contains("num_wg_l_2")) config.num_wg_l_2 = j["num_wg_l_2"];
        if (j.contains("num_wi_l_2")) config.num_wi_l_2 = j["num_wi_l_2"];
        if (j.contains("input_size_r_1")) config.input_size_r_1 = j["input_size_r_1"];
        if (j.contains("l_cb_size_r_1")) config.l_cb_size_r_1 = j["l_cb_size_r_1"];
        if (j.contains("p_cb_size_r_1")) config.p_cb_size_r_1 = j["p_cb_size_r_1"];
        if (j.contains("ocl_dim_r_1")) config.ocl_dim_r_1 = j["ocl_dim_r_1"];
        if (j.contains("num_wg_r_1")) config.num_wg_r_1 = j["num_wg_r_1"];
        if (j.contains("num_wi_r_1")) config.num_wi_r_1 = j["num_wi_r_1"];
        if (j.contains("l_reduction")) config.l_reduction = j["l_reduction"];
        if (j.contains("p_write_back")) config.p_write_back = j["p_write_back"];
        if (j.contains("l_write_back")) config.l_write_back = j["l_write_back"];
...
int main(int argc, char *argv[]) {
    ...
    std::cout << "Matrix dimensions: M=" << config.M << ", N=" << config.N << ", K=" << config.K << std::endl;
    ...
    std::string kernel_source_1 = read_kernel_source(get_kernel_template_path("gemm_1.cl").c_str());
    std::string kernel_source_2 = read_kernel_source(get_kernel_template_path("gemm_2.cl").c_str());
    ...
    std::string compile_flags = "-DTYPE_T=float -DTYPE_TS=float "
        "-DCACHE_L_CB=" + std::to_string(config.cache_l_cb) +
    ...
    for (int i = 0; i < 3; ++i) {
        if (local_size[i] == 0){
            //error case, exit
            std::cerr << "Error: Local size dimension " << i << " is zero." << std::endl;
            exit(1);
        }
    }
    ...
    if (needs_reduction) {
        ...
        global_size_2[0] = ((config.ocl_dim_l_1 == 0) * config.num_wg_l_1 * config.num_wi_l_1 + 
                    (config.ocl_dim_l_2 == 0) * config.num_wg_l_2 * config.num_wi_l_2 +
                    (config.ocl_dim_r_1 == 0) * config.num_wi_r_1);
        global_size_2[1] = ((config.ocl_dim_l_1 == 1) * config.num_wg_l_1 * config.num_wi_l_1 + 
                    (config.ocl_dim_l_2 == 1) * config.num_wg_l_2 * config.num_wi_l_2 +
                    (config.ocl_dim_r_1 == 1) * config.num_wi_r_1);
        global_size_2[2] = ((config.ocl_dim_l_1 == 2) * config.num_wg_l_1 * config.num_wi_l_1 + 
                    (config.ocl_dim_l_2 == 2) * config.num_wg_l_2 * config.num_wi_l_2 +
                    (config.ocl_dim_r_1 == 2) * config.num_wi_r_1);
        ...
        for (int i = 0; i < 3; ++i) {
            if (local_size_2[i] == 0){
                //error case, exit
                std::cerr << "Error: Local size dimension " << i << " for gemm_2 is zero." << std::endl;
                exit(1);
            }
        }
        ...
        std::cout << "No reduction needed (NUM_WG_R_1 = " << config.num_wg_r_1 << ")" << std::endl;
    }
